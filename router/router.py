...
from services.s3_service import upload_image_to_s3 import os import shutil
from internal.database import get_dynamodb,get_name
from internal.aws_config import aws_access
from pydantic import BaseModel
"""
from fastapi-app.domain.domain import NutrientsName

from fastapi-app.domain.domain import UserDomain, LogDomain, UserJoinModel, physique, MealLog
"""
...
async def upload_image(file: UploadFile = File(...)):
    ...
    # S3에 업로드
    s3_url = upload_image_to_s3(image_path, file.filename)
